...
class SinhvienFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'gioi_tinh' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'so_dien_thoai' => ['type' => 'string', 'length' => 15, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'mat_khau' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'ma_sinh_vien' => ['type' => 'unique', 'columns' => ['ma_sinh_vien'], 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'ngay_sinh' => '2025-02-22',
                'email' => 'Lorem ipsum dolor sit amet',
                'gioi_tinh' => 'Lorem ipsum dolor sit amet',
                'so_dien_thoai' => 'Lorem ipsum d',
